                    ...
                    <div class="main">
                        <center>
                            ...
                            <div style={{ marginLeft: "-100px" }}>
                                ...
                                {show &&
                                    <>
                                        <div className='col-4' >
                                            ...
                                            <div class="card card-2 hh" style={{ backgroundColor: oppo2,borderRadius:mere }}>
                                                ...
                                                <div id='gs2' style={{ textAlign: oppo4 }}>
                                            ...
                                            <center>
                                                ...
                                                <button  className='btn btn-success' onClick={ShowC} id="200px">Circule</button>
                                                <button  className='btn btn-success' onClick={ShowC} id="25px">curve</button>
                                            </center>
                                ...
                                {show1 && <>
                                    <div className='col-4' style={{ backgroundColor: oppo2}}>

                                        <div class="card card-2 hh"  style={{borderRadius:mere}}>
                                            <div class="logo-holder " id='bg3' >

                                                <h1 style={{ fontFamily: oppo, color: oppo1, textAlign: oppo4 }} >{logoname}</h1>
                                        ...
                                        <div class="card hh"  >
                                            <div className='container' id='gs7'><h1></h1>
                                                <div className='row' id='gs77'>
                                                    ...
                                                    <div class="col-10" id='gs8' style={{ backgroundColor: oppo2, fontFamily: oppo, textAlign: oppo4 }}><h1></h1>{sp[0]}</div>
                                                    <div className='col-1'></div>
                            ...
                            <div className='col-4'>
                                <div class="card hh"  >
                                    <div className='container' id='gs7'><h1></h1>
                                        <div className='row' id='gs77'>
                                            <div className='col-1'></div>
                                            <div class="col-10" id='gs8' style={{ backgroundColor: c8 }}><center>{sp[0]}</center></div>
                                            <div className='col-1'></div>
